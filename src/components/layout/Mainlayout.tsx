  ...
  return (
    <>
      ...
      <div className="bg-white h-full">
        ...
        <section id="features" className="relative mb-32 pt-40">
          <div className="relative mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
            <div className="text-center">
              <h2 className="text-4xl font-bold xl:text-5xl">Features</h2>
        ...
        <section id="pricing" className="overflow-x-clip pt-32 mb-32">
